...
import {
  Eye, EyeOff, Bot, Lock, Mail, AlertCircle, Loader, Sun, Moon,
...
export default function Login() {
  ...
  const [simProvider, setSimProvider] = useState('OpenAI');
  const [simStatus, setSimStatus]     = useState('Routing...');
      ...
      >
        ...
        <div className="max-w-xl my-auto relative z-10">
          ...
          <h1 className="text-4xl xl:text-5xl font-black tracking-tight leading-tight mb-4 animate-fade-up">
            Optimized LLM Routing <br />
            <span className="bg-gradient-to-r from-blue-600 to-indigo-500 bg-clip-text text-transparent">At Production Scale</span>
          </h1>

          <p className="text-base leading-relaxed mb-10 animate-fade-up delay-100" style={{ color: 'var(--text-muted)' }}>
            Seamlessly fall back, manage API keys, and allocate prompts across OpenAI, Anthropic, Gemini, and Groq dynamically while cutting token spending by up to 60%.
          </p>
          ...
          >
            ...
            <div className="font-mono text-xs space-y-3.5">
              <div className="flex items-start gap-2">
                ...
                <span style={{ color: 'var(--text-secondary)' }}>"Generate optimized Rust code to handle concurrent SSE connections..."</span>
              </div>
          ...
          <div className="auth-card p-8 shadow-2xl relative"
            ...
            <div className="flex flex-col items-center mb-8 lg:mb-10 text-center">
              ...
              <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>
                Sign in to manage your AI prompt gateway
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" disabled={isLoading} className="btn-primary w-full flex items-center justify-center gap-2 mt-2 py-3">
                {isLoading ? (
                  <><Loader className="w-4.5 h-4.5 animate-spin" /><span>Verifying account…</span></>
                ) : (
            ...
            <div className="mt-7 pt-5 text-center text-sm border-t"
              ...
              <Link to="/signup" className="font-semibold transition-colors hover:underline" style={{ color: 'var(--brand)' }}>
                Create one
              </Link>
            </div>
          </div>
